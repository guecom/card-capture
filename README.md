...
| `docs/` | 모바일 캡처 PWA, rollback용 `legacy.html`, 기기 내 OCR·조사 지시 policy helper | GitHub Pages (이 저장소) |
...
- 공개 GAS 배포 URL은 rollback baseline인 `docs/legacy.html`의 `DEFAULT_API`가 소유하며 React build가 같은 값을 주입한다.
