...
/* PowerShell 실물 대조로 맞춘 렌더 지문. 워처를 `$CardCaptureWatcherTestMode = $true`로 dot-source해
   ...
   (LF 5403자). 워처 파일은 CRLF이므로 **정규화 없이 해시하면 값이 다르다.**
...
var GROUND_TRUTH_PROMPT_SHA256 = '5957c2ad868db19a71c113b97b03dfce7aec9c1bf963d760a2fe3749be936f53';
...
runCase('prompt-render-matches-powershell', '이 파일이 재현하는 프롬프트가 PowerShell이 실제로 만드는 문자열과 같다', function () {
  ...
  eq(text.length, 5403, '렌더 길이가 대조 시점과 다르다');
